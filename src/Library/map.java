...
public class map extends javax.swing.JFrame {
    ...
    double lat = 26.3850387;
    double lon = 50.1891363;
    public map() {
        initComponents();
        initx();
        jButton5=new JButton("Set");
        jButton5.setSize(54,28);
        jButton5.setLocation(464, 85);
        jButton5.addActionListener(new ActionListener(){
            
            @Override
            public void actionPerformed(ActionEvent e) {
    JOptionPane.showMessageDialog(null, "Your Location has been confirmed!");
            }
        });
                this.add(jButton5);
    ...
    private void initx() {
        ...
        GeoPosition kandy = new GeoPosition(26.3850387, 50.1891363);
