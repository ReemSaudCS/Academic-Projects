...
public class User {
    ...
    public void checkInformation(String username,String pass,String role,JFrame login){
    try{
        ...
        Boolean found=false;
            ...
            rs2=st.executeQuery();
            while(rs2.next()){
            if(pass.equals(rs2.getString("Admin_pass"))){
                    JOptionPane.showMessageDialog(null,"Welcome Back Admin:"+username);
                    new AdminView().setVisible(true);
                    login.setVisible(false);
            }
            else if(!pass.equals(rs2.getString("Admin_pass"))){
