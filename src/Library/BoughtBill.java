...
//               pp.add(books[i]);
       ...
       for(int i=0;i<b.size();i++){
         ...
         st2=mainclass.con.createStatement();
       rs2=st2.executeQuery("Select * from buy_table where Bill_no='"+Bill_no+"'");
              while(rs2.next()){

              lbl_Amount.setText(rs2.getString("Price"));
...
//    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("----------------------------------------------------");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 320, 252, -1));
