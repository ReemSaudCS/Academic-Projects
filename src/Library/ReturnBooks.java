    ...
    private void comboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboActionPerformed
        ...
        try{
           String query="select * from borrow_table where Bill_no='"+combo.getSelectedItem().toString()+"'";
                  st=mainclass.con.createStatement();
...
//        java.sql.Date date=new java.sql.Date(millis);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PreparedStatement up=mainclass.con.prepareStatement("update book_table set quantity=? where Title='"+title.getText()+"'");
            up.setInt(1,quantity);
            up.executeUpdate();
                    
        PreparedStatement up2=mainclass.con.prepareStatement("update borrow_table set Return_date=? where Bill_no='"+combo.getSelectedItem()+"'");
            up2.setDate(1,date);
            up2.executeUpdate();
                    JOptionPane.showMessageDialog(null,"Book Returned Successfuly! Thank you");
        }else{
                        JOptionPane.showMessageDialog(null,"you missed the due date");
    ...
    public void fillcombo(String username){
        ...
        st=mainclass.con.createStatement();
        ResultSet rs2=st.executeQuery("Select * from borrow_table where Return_date is null AND Cust_id='"+id+"'");
        while(rs2.next()){
